...
const pintarEnvio = (e) => {
    ...
    <div class="cont-card">
        <div class="card">
            <div class="card-header header-envio">
                <div class="cont-depto"> <h2 class="card-subtitle">${e.ciudad_tienda}</h2> <span class="txt-depto">${e.depto}</span></div> <span class="badge bg-primary">Envío gratis</span>
